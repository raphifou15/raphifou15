 ...
 * @brief Implémentation des fonctions utilitaires pour get_next_line.
 */
 ...
 * @return Une nouvelle chaîne de caractères, ou NULL en cas d'échec d'allocation.
 */
 ...
 * @param carriage Indique si la fonction doit arrêter la recherche
 * au premier caractère de retour à la ligne.
 * @return La longueur de la chaîne de caractères, ou la position du
 * premier caractère de retour à la ligne si carriage est non nul.
 */
 ...
 * @return Une nouvelle chaîne de caractères contenant la concaténation
 * de `s1` et `s2`, ou NULL en cas d'échec d'allocation.
 */
 ...
 * @return Une nouvelle chaîne de caractères vide, ou NULL en cas d'échec d'allocation.
 */
char	*ft_str(char *s)
{
	char	*str;
