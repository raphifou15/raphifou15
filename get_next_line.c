 ...
 * @return La nouvelle chaîne de caractères, ou NULL en cas d'erreur.
 */
 ...
 * @param i L'indice de la première occurrence d'un caractère.
 * @return La nouvelle chaîne de caractères, ou NULL en cas d'erreur.
 */
...
/**
 * @brief Extrait la ligne et met à jour la chaîne de caractères restante.
 * 
 * @param reste La chaîne de caractères restante.
 * @param line Pointeur vers la ligne extraite.
 ...
 * @param line Pointeur vers la ligne lue.
